...
export class EntrenadorController {
    ...
    constructor() {
        ...
        this.createUseCase = new CreateEntrenadorUseCase(repository);
        this.updateUseCase = new UpdateEntrenadorUseCase(repository);
        this.deleteUseCase = new DeleteEntrenadorUseCase(repository);
